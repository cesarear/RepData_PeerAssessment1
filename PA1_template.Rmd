...
```{r, echo=TRUE}
newDS <- actData
# rewite NAs in stesp with mean by interval
...
A: small change in the median, mean is the same since no outlier were introduced, just a chenge in the distribution.  
